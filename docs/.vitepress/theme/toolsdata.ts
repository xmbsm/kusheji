...
export const toolsdata: Tools[] = [
  {
    ...
    items: [
      ...
      {
        icon: 'https://static.kusheji.com/2026/03/k-logo.png',
        title: '海外素材',
        desc: '海外商业精品素材下载',
        link: 'https://sucai.kusheji.com/',
        linktxt: 'sucai.kusheji.com',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://cover.dsxdh.com/favicon/favicon-32x32.png',
        title: '封面图片生成器',
        desc: '更好的封面图像生成器工具',
        link: 'https://cover.dsxdh.com/',
        linktxt: 'cover.dsxdh.com',
      },
      {
        icon: 'https://coverview.dsxdh.com/logo.png',
        title: 'CoverView',
        desc: '非常容易的为你的博客创建封面图片',
        link: 'https://coverview.dsxdh.com/',
        linktxt: 'coverview.dsxdh.com',
      }
    ],
  },
  {
